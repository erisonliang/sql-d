...
wget -O ./build/sql-d.start.osx-x64.nupkg https://www.nuget.org/api/v2/package/sql-d.start.osx-x64/1.0.7
...
dotnet tool install --global dotnet-cli-zip
wget -O ./build/sql-d.ui.osx-x64.nupkg https://www.nuget.org/api/v2/package/sql-d.ui.osx-x64/1.0.7
