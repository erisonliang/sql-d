...
xcopy /E /F /Y /S src\sql-d.ui.linux-x64\bin\Release\netcoreapp2.2\sql-d.start src\sql-d.ui.linux-x64\bin\Release\netcoreapp2.2\linux-x64\publish\sql-d.start\
...
xcopy /E /F /Y /S src\sql-d.ui.osx-x64\bin\Release\netcoreapp2.2\sql-d.start src\sql-d.ui.osx-x64\bin\Release\netcoreapp2.2\osx-x64\publish\sql-d.start\
...
xcopy /E /F /Y /S src\sql-d.ui.win-x64\bin\Release\netcoreapp2.2\sql-d.start src\sql-d.ui.win-x64\bin\Release\netcoreapp2.2\win-x64\publish\sql-d.start\
